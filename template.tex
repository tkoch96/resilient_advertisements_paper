...
\documentclass[letterpaper,twocolumn,10pt,sigconf,nonacm]{article}
\usepackage{usenix}
...
% use upquote if available, for straight quotes in verbatim environments
% \IfFileExists{usenix.sty}{\usepackage{usenix}}{}
...
$endif$
$if(biblatex)$
\usepackage[backend=bibtex,hyperref=true,style=numeric,backref=false,maxnames=99,style=trad-abbrv,firstinits=true]{biblatex}
$for(bibliography)$
...
\author{
\normalfont
Paper \#156, \pageref{sec:end-of-conclusion} pages body, 23 pages total \\
}
